...
//-----------------------------------------------------------------------------
double FleeGoal_Evaluator::CalculateDesirability(Raven_Bot* pBot)
{
...
//----------------------------- SetGoal ---------------------------------------
//-----------------------------------------------------------------------------
void FleeGoal_Evaluator::SetGoal(Raven_Bot* pBot)
{
    pBot->GetBrain()->AddGoal_FleeCuzOfStress();
}

//-------------------------- RenderInfo ---------------------------------------
//-----------------------------------------------------------------------------
void FleeGoal_Evaluator::RenderInfo(Vector2D Position, Raven_Bot* pBot)
{
